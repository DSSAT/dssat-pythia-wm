...
git checkout tags/2.1.7 -b 2.1.7 && \
/root/.local/bin/poetry build && cd dist && pip3 install pythia-2.1.7-py3-none-any.whl
...
curl --create-dirs -o /usr/local/share/world-modelers/ethiopia-base-latest.tar.bz2 https://data.agmip.org/darpa/ethiopia-base-20220411.tar.bz2 && \
...
cd dojo-scripts && git checkout 54fd49da899394fc23c0f8cb732f0167f1cec50a -b eth
